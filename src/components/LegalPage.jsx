    ...
    <div className="legal-page flex flex-col gap-5 max-w-5xl mx-auto">
      ...
      <div className="card glass-panel legal-hero-card flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5">
        <div className="flex items-center gap-4">
          <div className="modal-icon-badge icon-badge-cyan legal-hero-icon shrink-0">
      ...
      <div className="card glass-panel p-6">
        {/* Navigation Tabs Bar */}
        <div className="legal-tabs-bar no-print mb-6">
          <span
        ...
        <div className="legal-content-body max-w-4xl">
          {activeTab === 'terms' && (
            <div key="terms" className="legal-section legal-content-anim flex flex-col gap-5">
              <div>
                <h3 className="text-base font-bold text-ink-1">1. Dealership ERP & Sales Terms of Service</h3>
                <div className="legal-meta-row flex items-center gap-2 flex-wrap mt-3">
              ...
              <div className="legal-text-block flex flex-col gap-4">
          ...
          {activeTab === 'privacy' && (
            <div key="privacy" className="legal-section legal-content-anim flex flex-col gap-5">
              <div>
          ...
          {activeTab === 'warranty' && (
            <div key="warranty" className="legal-section legal-content-anim flex flex-col gap-5">
              <div>
        ...
        {/* Verified Footer Bar */}
        <div className="mt-8 pt-6 border-t border-line-soft flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-sm legal-verified-footer">
          ...
          <div className="text-xs font-mono text-ink-4 flex items-center gap-2">
            <span>Doc ID: AST-LEGAL-2026-v2</span>
            <span className="hidden sm:inline text-ink-5">•</span>
