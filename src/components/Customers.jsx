          ...
          <div className="page-form-header no-print">
            ...
            <div className="page-form-title-group">
              ...
              <div className="page-form-subtitle">
                Comprehensive Client Profile, Acquired Vehicles, Invoicing History & Financial Ledger
              </div>
            </div>
          ...
          <div className="page-form-container">
            ...
            <div className="page-form-card">
                ...
                <div className="customer-hero-info">
                  <div className="hero-name-row">
                    ...
                    <span className={`glass-badge ${selectedCustomer.remainingBalance > 0 ? 'badge-rose' : 'badge-emerald'}`}>
                      ...
                      {selectedCustomer.remainingBalance > 0 ? 'Outstanding Dues' : 'Account Settled'}
                    </span>
                  </div>
                  ...
                  <div className="customer-contacts-grid">
                    ...
                    {selectedCustomer.cnic && (
                      <div className="contact-item" onClick={() => copyToClipboard(selectedCustomer.cnic)} title="Click to copy CNIC">
                        ...
                        <span className="font-mono">CNIC: {selectedCustomer.cnic}</span>
                      </div>
                    )}
              ...
              <div className="stats-strip mt-3">
                ...
                <div className="strip-item">
                  <span className="strip-label">Total Cleared</span>
                  <strong className="strip-val text-emerald font-mono">{formatPKR(selectedCustomer.totalPaid)}</strong>
                </div>
                <div className="strip-item">
                  <span className="strip-label">Outstanding Balance</span>
                ...
                <div className="strip-item">
                  <span className="strip-label">Motorcycles Acquired</span>
                  <strong className="strip-val text-amber">{selectedCustomer.totalPurchases} Units</strong>
                </div>
              </div>
            </div>
            ...
            <div className="page-form-card">
              <div className="page-form-card-title">
                Acquired Motorcycle Fleet ({selectedCustomer.purchasedBikes.length} Vehicles)
              </div>
                  ...
                  <div key={idx} className="customer-bike-tile glass-panel">
                    <div className="tile-top">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted">Model Year {bike.modelYear} • {bike.color}</div>
                      </div>
                      <span className="glass-badge badge-muted text-xs ml-auto">
                        Invoice #{bike.invoiceNumber}
                      </span>
                    </div>
            ...
            <div className="page-form-card">
              <div className="page-form-card-title">
                Sales Contracts & Ledger History ({selectedCustomer.sales.length} Invoices)
              </div>
                ...
                {selectedCustomer.sales.map((sale) => (
                  <div key={sale.id} className="customer-sale-card glass-panel mb-3">
                    ...
                    <div className="sale-financial-breakdown">
                      <div><span>Total Payable:</span> <strong>{formatPKR(sale.finalAmount)}</strong></div>
                      <div><span>Remaining Balance:</span> <strong className={sale.remainingBalance > 0 ? 'text-rose' : 'text-emerald'}>{formatPKR(sale.remainingBalance)}</strong></div>
                    ...
                    {sale.installments && sale.installments.length > 0 && (
                      <div className="customer-installments-table-wrap mt-3">
                        <div className="text-xs font-bold uppercase text-muted mb-2">Installment Schedule</div>
    ...
    <div className="customers-view">
      ...
      {loading ? (
        <div className="loading-state">
          ...
          <p>Loading Customer Records & Financial Ledgers...</p>
        </div>
      ) : customers.length === 0 ? (
        <div className="empty-state glass-panel">
          <Users size={48} className="text-muted mb-2" />
          <h3>No Customer Records Found</h3>
          <p className="text-muted text-sm">No clients match the specified search or filter criteria.</p>
        </div>
      ) : viewMode === 'grid' ? (
            ...
            >
              ...
              <div className="customer-card-body">
                ...
                <div className="customer-balance-box">
                  ...
                  <strong className={`font-mono ${c.remainingBalance > 0 ? 'text-rose' : 'text-emerald'}`}>
                    {c.remainingBalance > 0 ? formatPKR(c.remainingBalance) : 'Fully Cleared'}
                  </strong>
                </div>
              ...
              <div className="customer-card-footer">
                <span className="text-xs text-muted">
                  Active: {new Date(c.lastPurchaseDate).toLocaleDateString('en-GB')}
                </span>
                ...
                <tr key={c.id} onClick={() => setSelectedCustomer(c)} className="clickable-row">
                  ...
                  <td>
                    <span className={`glass-badge ${c.remainingBalance > 0 ? 'badge-rose' : 'badge-emerald'}`}>
                      <span className="status-dot" />
                      {c.remainingBalance > 0 ? 'Dues' : 'Cleared'}
                    </span>
                  </td>
